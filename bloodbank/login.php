...
<body>
  <?php require 'header.php'; ?>
    ...
    <div class="container cont">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#donors">Donors</a> <!-- Added -->
    </li>
     <li class="nav-item">
    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container fade" id="donors"> <!-- Added -->
        <form action="file/donorLogin.php" method="post"> <!-- Form for donor login -->
